    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                // Default
                res.status(500).json({ error: error_2.message || 'Failed to create user' });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                if (error_3 instanceof Prisma.PrismaClientKnownRequestError) {
                    // Record not found
                    if (error_3.code === 'P2025') {
                        return [2 /*return*/, res.status(404).json({ error: 'User not found' })];
                    }
                }
                res.status(500).json({ error: error_3.message || 'Failed to delete user' });
                return [3 /*break*/, 4];
